          ...
          >
            {CORE_TECH.map((tech, index) => (
              ...
              >
                ...
                <span className="text-[11px] text-neutral-600 dark:text-neutral-400 mt-2 font-semibold group-hover:text-neutral-900 dark:group-hover:text-white transition-colors uppercase tracking-widest">{tech.Name}</span>
              </motion.div>
            ))}
          </motion.div>
        </div>
