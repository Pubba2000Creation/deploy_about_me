...
const CORE_TECH = [
    ...
    { Name: "Node (Express)", Icon: SiExpress, Color: "text-neutral-800 dark:text-neutral-100" },
    ...
    { Name: "Electron", Icon: SiElectron, Color: "text-cyan-600 dark:text-cyan-300" },
    { Name: "OpenCV", Icon: SiOpencv, Color: "text-green-600 dark:text-green-400" },
    { Name: "YOLO", Icon: AiOutlineScan, Color: "text-yellow-600 dark:text-yellow-400" },
    ...
    { Name: "Linux", Icon: SiLinux, Color: "text-neutral-700 dark:text-white" },
    { Name: "React", Icon: SiReact  , Color: "text-cyan-400" },
];

const TechnologiesSummary = () => {
  return (
    <div id="technologies-summary" className="scroll-mt-24 border-b border-neutral-200 dark:border-neutral-900 pb-20 px-4 sm:px-6 lg:px-8 mt-10">
        ...
        <div className="flex flex-col lg:flex-row items-center justify-between gap-12">
          ...
          >
            {CORE_TECH.map((tech, index) => (
              <motion.div
                key={index}
                whileHover={{ scale: 1.1, backgroundColor: "rgba(38, 38, 38, 0.05)" }}
                className="flex flex-col items-center justify-center p-4 rounded-2xl bg-neutral-50/50 dark:bg-neutral-900/30 border border-neutral-200 dark:border-neutral-800/50 backdrop-blur-sm transition-all group"
              >
                <tech.Icon className={`text-3xl ${tech.Color} group-hover:animate-pulse`} />
                <span className="text-[10px] text-neutral-500 dark:text-neutral-500 mt-2 font-light group-hover:text-neutral-900 dark:group-hover:text-neutral-300 transition-colors uppercase tracking-widest">{tech.Name}</span>
              </motion.div>
            ))}
          </motion.div>
        </div>
