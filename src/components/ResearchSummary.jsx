...
const ResearchSummary = () => {
  ...
  return (
    <div id="research-summary" className="scroll-mt-24 border-b border-neutral-900 pb-20 px-4 sm:px-6 lg:px-8 mt-10">
      <div className="max-w-6xl mx-auto">
        <div className="flex flex-col lg:flex-row-reverse items-center justify-between gap-12">
          ...
          >
            ...
            <Link
              to="/research"
              className="inline-flex items-center gap-3 px-8 py-4 bg-blue-600 hover:bg-blue-700 text-white rounded-xl font-bold transition-all shadow-xl shadow-blue-900/20 group"
            >
            ...
            <div className="p-8 rounded-3xl bg-neutral-900/40 border border-neutral-800/50 backdrop-blur-xl relative overflow-hidden group">
              ...
              <div className="flex flex-wrap gap-2 mb-6">
                {latestResearch.technologies.slice(0, 4).map((tech, i) => (
                  <span key={i} className="px-2 py-1 bg-neutral-950 border border-neutral-800 rounded text-[10px] text-blue-300/70">
                    {tech}
                  </span>
                ))}
                <span className="text-[10px] text-neutral-600 self-center">+{latestResearch.technologies.length - 4} more</span>
              </div>
